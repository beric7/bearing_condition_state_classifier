...
"""
def csv_to_sub_image(csv_file, sourceImageDirectory, destinationDirectory): 
    ...
    for rowList in tqdm(rows):
        ...
        cv2.imwrite(destinationFolder + str(count+1) + '_' + classType +'.jpeg', window)
